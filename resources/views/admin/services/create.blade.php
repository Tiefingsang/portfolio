        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          ...
                          placeholder="Description courte du service">{{ old('description') }}</textarea>
            ...
            <div>
                ...
                <textarea name="meta_description" rows="2"
                          ...
                          placeholder="Description pour le référencement">{{ old('meta_description') }}</textarea>
...
<script>
    ...
    document.querySelector('input[name="title"]').addEventListener('keyup', function() {
        // Vous pouvez ajouter ici la génération du slug si nécessaire
    });
</script>
@endpush
@endsection
